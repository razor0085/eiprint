...
/**
 * Verteilt Schritte anhand aList gleichmässig auf erzeugtes Array
 * @author sugolini
 */
public class Parsedata {
    ...
    public void parsedata(ArrayList<Integer> alist) {
        ...
        for (int x = 0; x < alist.size(); x += 5) {
            ...
            //Fehlerkompensation füllt durch die Rundung verlorengegangene Schritte auf
